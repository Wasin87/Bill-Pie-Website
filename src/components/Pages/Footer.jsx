...
const Footer = () => {
  return (
    <footer className="footer sm:footer-horizontal  p-10 text-black bg-linear-to-r from-amber-500 to-amber-200 dark:from-gray-700 dark:to-amber-900 dark:text-gray-200 transition-colors duration-300">
      <aside>
        <img
